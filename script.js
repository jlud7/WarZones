/*
 * WarZones root script. GAME_CONSTANTS and GameState live in
 * lib/game-state.js (loaded as a classic <script> before this one) so
 * the rules engine can be unit-tested in Node without a DOM.
 */
