...
(function (global) {
  ...
  const GAME_CONSTANTS = {
    ...
    TREASURE: {
      symbol: '💎',
      image: 'assets/icons/treasure-chest.png',
      name: 'Treasure Chest',
      chance: 1.00
    },
    POWERUPS: {
      BlackBox: {
        ...
        icon: '<img src="assets/icons/black-box.png" class="icon-img" alt="">'
      },
      KryptonLaser: {
        name: 'KRYPTON LASER',
        description: 'Attack the same cell position across all four layers',
        icon: '<img src="assets/icons/krypton-laser.png" class="icon-img" alt="">'
      },
      CannonBall: {
        name: 'CANNON BALL',
        description: 'Attack a 2×2 area on the sea layer',
        icon: '<img src="assets/icons/cannon-ball.png" class="icon-img" alt="">'
      }
    }
  };
