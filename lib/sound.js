 ...
 * SoundManager module.
 *
 * Web Audio synthesis for in-game sound effects. Dual-mode loader: via
 * <script> tag it installs SoundManager on the global object; under Node
 * (tests) it exposes it via module.exports.
 */
(function (global) {
  'use strict';
